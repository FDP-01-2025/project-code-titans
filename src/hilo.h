...
inline void hilo(Player &player, int &bet)
{                                // Receives reference to player and bet (by reference to modify)
    ...
    while (keep == true)
    { // While the player decides to continue
        ...
        while (true)
        {
            ...
            cin >> guess;
            if (guess == 'M' || guess == 'm' || guess == 'L' || guess == 'l')
                break; // Accept M/m and L/l (higher/lower)
        ...
        {                  // Guessed lower and it is lower
            ...
            while (true)
            {
                ...
                cin >> going;
                if (going == 'S' || going == 's' || going == 'N' || going == 'n')
                    break;
