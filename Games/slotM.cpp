...
void easyMode()
{
    ...
    while (true)
    {                   // while infinite for the player to decide to continue playing
        srand(time(0)); // randomness

        for (int i = 4; i > 0; i--)
        { // for loop that repeats each shot 4 times

            while (true)
            { // while infinite to show the player the remaining shots
            ...
            while (true)
            {
                ...
                if (pull == "!")
                {
                    ...
                    if (jackpotE(symbols))
                    { // calls the function to check if all symbols are equal
        ...
        if (playerLose == 1)
        { // if variable is equal to 1 the player lost
            cout << endl;
        ...
        while (true)
        {                 // infinite while to validate that a valid character was entered
            setColor(36); // cian
        ...
        {          // validate if the player chose yes or no
...
void mediumMode()
{
    ...
    {                   // while infinite for the player to decide to continue playing
        ...
        for (int i = 8; i > 0; i--)
        { // for loop that repeats each shot 8 times
...
void hardMode()
{
    ...
    { // while infinite for the player to decide to continue playing
        ...
        for (int i = 15; i > 0; i--)
        { // for loop that repeats each shot 15 times
